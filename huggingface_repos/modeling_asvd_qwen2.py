...
from .configuration_asvd_qwen2 import ASVDQwen2Config
...
class ASVDQwen2ForCausalLM(Qwen2ForCausalLM):
    config_class = ASVDQwen2Config

    def __init__(self, config: ASVDQwen2Config):
