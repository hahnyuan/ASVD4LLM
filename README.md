...
CUDA_VISIBLE_DEVICES='2' python experiments/sensitivity_split.py --model_id="huggyllama/llama-7b" --ppl_target 8 --act_aware --test_split 1 --alpha 0.5 --n_calib_samples 16 --calib_dataset ptb

CUDA_VISIBLE_DEVICES='3' python experiments/sensitivity_split.py --model_id="meta-llama/Llama-2-7b-hf" --ppl_target 6.5 --act_aware --test_split 1 --alpha 0.5 --n_calib_samples 16 --calib_dataset ptb
...
CUDA_VISIBLE_DEVICES='1' python experiments/ppl_line.py --model_id="huggyllama/llama-7b" --act_aware --test_split 1 --alpha 0.5 --n_calib_samples 16 --calib_dataset ptb

CUDA_VISIBLE_DEVICES='0' python experiments/ppl_line.py --model_id="huggyllama/llama-7b" --act_aware --test_split 1 --alpha 0.5 --n_calib_samples 32 --interval 50

CUDA_VISIBLE_DEVICES='3' python experiments/ppl_line.py --model_id="meta-llama/Llama-2-7b-hf" --act_aware --test_split 1 --alpha 0.5 --n_calib_samples 32 --interval 50

# run main result

CUDA_VISIBLE_DEVICES='0' python experiments/run_main_result.py --model_id="facebook/opt-125m" --test_split 1 --alpha 0.5 --n_calib_samples 16

CUDA_VISIBLE_DEVICES='0' python experiments/run_main_result.py --model_id="huggyllama/llama-7b" --test_split 1 --alpha 0.5 --n_calib_samples 32

CUDA_VISIBLE_DEVICES='1' python experiments/run_main_result.py --model_id="meta-llama/Llama-2-7b-hf" --test_split 1 --alpha 0.5 --n_calib_samples 32

# quantization asvd
CUDA_VISIBLE_DEVICES='0' python experiments/quantization_asvd.py --model_id="facebook/opt-125m"  --test_split 1 --alpha 0.5

CUDA_VISIBLE_DEVICES='2' python experiments/quantization_asvd.py --model_id="huggyllama/llama-7b" --test_split 1 --alpha 0.5 --n_calib_samples 32

CUDA_VISIBLE_DEVICES='3' python experiments/quantization_asvd.py --model_id="meta-llama/Llama-2-7b-hf" --test_split 1 --alpha 0.5 --n_calib_samples 32

CUDA_VISIBLE_DEVICES='2' python experiments/quantization_asvd.py --model_id="huggyllama/llama-7b" --test_split 1 --alpha 0.5 --n_calib_samples 32 --wbits 4

CUDA_VISIBLE_DEVICES='3' python experiments/quantization_asvd.py --model_id="meta-llama/Llama-2-7b-hf" --test_split 1 --alpha 0.5 --n_calib_samples 32 --wbits 4
